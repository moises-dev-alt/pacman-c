...
#define SHIELD_TIME       100
#define SPEED_TIME        100
#define GHOST_SLOW_TIME   100
#define TIME_FREEZE_TIME  100
#define DOUBLE_TIME       90
...
#define CLR_WALL        "\033[38;5;57m"
#define CLR_PELLET      "\033[38;5;227m"
#define CLR_POWER       "\033[38;5;201;1m"
#define CLR_DOOR        "\033[38;5;168m"

#define CLR_PACMAN      "\033[38;5;220;1m"
#define CLR_BLINKY      "\033[38;5;201;1m"
#define CLR_PINKY       "\033[38;5;207;1m"
#define CLR_INKY        "\033[38;5;51;1m"
#define CLR_CLYDE       "\033[38;5;208;1m"
#define CLR_VULN        "\033[38;5;117;1m"
...
typedef struct {
    ...
    /* Modo auto-play */
    int auto_play;
    int auto_bfs_dist[MAP_H * MAP_W];
    int auto_bfs_prev[MAP_H * MAP_W];
    ...
    int shield_timer;
    int speed_timer;
    int ghost_slow_timer;
    int time_freeze_timer;
    int double_score_timer;
    int difficulty;
    int map_variant;
